            ...
            children: [
              ...
              if (_type != 'transfer') ...[
                ...
                DropdownButtonFormField<String>(
                  ...
                  items: store.categories.where((c) => c.type == _type).map((c) => DropdownMenuItem(value: c.id, child: Text(c.name))).toList(),
              ...
              if (_type == 'transfer') ...[
                ...
                DropdownButtonFormField<String>(
                  ...
                  items: store.accounts.where((a) => a.id != _accountId).map((a) => DropdownMenuItem(value: a.id, child: Text(a.name))).toList(),
