                        ...
                        Expanded(
                          child: Row(
                            children: [
                              ...
                              Text(': ${store.rates[codes[r * 3 + c]]!.toStringAsFixed(1)}', style: Theme.of(context).textTheme.bodyMedium!.copyWith(color: AppColors.textSecondaryFor(context))),
                            ],
                          ),
                        ),
                    ],
            ...
            child: GestureDetector(
              ...
              child: AppCard(
                ...
                children: [
                  ...
                  Text('${store.fmt(bal)} / ${store.fmt(g.targetAmount)}', style: TextStyle(fontSize: 13, color: AppColors.textSecondaryFor(context))),
                ],
              ),
            ),
          ),
